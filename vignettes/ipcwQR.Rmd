...
Finally, we cover multivariate doubly-censored data with normal random error, which is one of MVDC data simulation setting of Kim et al. (2022+).
...
In real data analysis, we apply our proposed method to the multivariate clustered data using a phase 3 metastatic colorectal cancer clinical trial. This dataset is accessible for data(mCRC) in the PICBayes R package (Pan, 2021).
